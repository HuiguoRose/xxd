...
func main() {
	...
	var request_par IDIP_DO_SEND_ITEM_REQ

	request_par.Head.PacketLen = 0
	request_par.Head.Cmdid = 0x1017
	...
	request_par.Body.ItemId = 5000
	request_par.Body.ItemNum = 1
	...
	fmt.Println(cmd)
	req2 := new(IDIP_DO_SEND_ITEM_RSP)
