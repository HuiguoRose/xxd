...
func main() {
	...
	var request_par IDIP_DO_SET_SWORD_LEVEL_REQ

	request_par.Head.PacketLen = 0
	request_par.Head.Cmdid = 4155
	...
	request_par.Body.RoleId = 1
	request_par.Body.Pos = 2
	request_par.Body.Value = 2
	...
	fmt.Println(cmd)
	req2 := new(IDIP_DO_SET_SWORD_LEVEL_RSP)
