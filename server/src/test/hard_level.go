...
func main() {
	...
	client.Player_FromPlatformLogin("hard14", "hard14", 1, "", 0, false)
	...
	client.OutMission_EnterLevel = func(out *mission_api.EnterLevel_Out) {
		fmt.Println("\n==============")
		fmt.Printf("mission_api.EnterLevel:\n%#v\n", out)
		fmt.Println("==============\n")
	}

	client.OutBattle_StartBattle = func(out *battle_api.StartBattle_Out) {
		fmt.Println("\n==============")
		fmt.Printf("battle_api.StartBattle:\n%#v\n", out)
		fmt.Println("==============\n")
	}

	client.OutBattle_NextRound = func(out *battle_api.NextRound_Out) {
		fmt.Println("\n==============")
		fmt.Printf("battle_api.NextRound:\n%#v\n", out)
		fmt.Println("==============\n")
	}
