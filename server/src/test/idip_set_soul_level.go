...
func main() {
	...
	var request_par IDIP_DO_SET_SOUL_LEVEL_REQ

	request_par.Head.PacketLen = 0
	request_par.Head.Cmdid = 4153
	...
	request_par.Body.SoulId = 1
	request_par.Body.Value = 90
	...
	fmt.Println(cmd)
	req2 := new(IDIP_DO_SET_SOUL_LEVEL_RSP)
