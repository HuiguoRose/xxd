...
func main() {
	...
	var request_par IDIP_QUERY_BAG_INFO_REQ

	request_par.Head.PacketLen = 0
	request_par.Head.Cmdid = 4137
	...
	request_par.Body.BeginTime = 0
	request_par.Body.EndTime = 0
	...
	fmt.Println(cmd)
	req2 := new(IDIP_QUERY_BAG_INFO_RSP)
